            ...
            <Dialog open={open}
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-text">
                        ...
                        <p>You need <b>at least 4 people</b> to play. In a first stage, everyone will have to <b>answer
                            some prompts</b> by themselves.
                            Then, you will battle against your friends in a series of <b>quiz questions based on the
                                answers everyone gave</b>.
                            The person that guesses the most questions correctly the fastest will win the game! And
                            don't worry, you can play again as often as you'd like ;)</p>
                        ...
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    Anyone that <b>enters the pin or scans the QR code</b> shown in the lobby can enter
                                    the game, as long as the host did not start it.
                        ...
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    That entirely depends on your group! Once the game is started, the <b>host will
                                    select how many prompts of each type</b> will be given to everyone for filling out.
                                    Each prompt should take no more than 30 seconds to complete.<br/>
                                    Additionally, the <b>host can set a timer</b> to limit how long players have to give
                                    their answers <b>during the quiz</b>. The faster the answer, the more points.
                                    If you choose to <b>play without a timer</b>, you can take as long as you want to
                                    pick an answer and only the correctness will matter.<br/>
                                    <i>Our recommendation: if someone in the group is hanging behind, the rest of the
                                        players should hassle them a bit to speed up the process.</i>
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    For true-false prompts, players will need to write a brief story about something and
                                    then mark whether this is true or a lie.<br/><br/>
                                    <b>Example Prompt:</b> <i>Tell a story about your best friend.</i><br/>
                                    <b>Example Quiz Question:</b> <i>Which player told this true story about their best
                                    friend?</i><br/>
                                    <b>Example Quiz Question:</b> <i>Is this story about somePlayerName's best friend
                                    true or false?</i>
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    ...
                                    <b>Example Quiz Question:</b> <i>Who would name their pet alligator 'some funny
                                    answer'?</i><br/>
                                    <b>Example Quiz Question:</b> <i>What would somePlayerName name their pet
                                    alligator?</i>
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        ...
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    There will be <b>at least two questions per prompt</b>. Since everyone is allowed to
                                    answer every quiz question, <b>each player will have their prompt answers
                                    as the chosen correct one the same number of times</b>, to ensure no unfair
                                    advantage for anyone. <br/>
                        ...
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    ...
                                    browser cache</b> and reloading whatever page you're on. This should lead you to the
                                    startpage, where
